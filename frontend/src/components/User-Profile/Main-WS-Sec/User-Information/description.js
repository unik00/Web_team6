...
class Description extends Component {
    ...
    render() {
        let { my_profile,description, regetData } = this.props
        let {openEditForm} = this.state
        return (
            <div className="user-profile-ov st2">
                <h3>
                    <div style={{ display: 'inline-block', cursor: 'pointer'  }}>Description </div>
                    {my_profile ? <div style={{ display: 'inline-block', cursor: 'pointer'  }} onClick={this.toggleEditForm}>
